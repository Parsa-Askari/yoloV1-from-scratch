...
from evaluations import calculate_iou as intersection_over_union
...
class TestIntersectionOverUnion(unittest.TestCase):
    ...
    #         self.t12_bboxes1, self.t12_bboxes2
    #     )
    #     all_true = torch.all(
